const UploadsForm = ({getRootProps, getInputProps, errors}: any) => {
    return (
        <div className="flex flex-col h-full w-[704px]">
            ...
            <div {...getRootProps({ className: "dropzone" })} className="flex-1">
                ...
                <div className="w-full h-full flex items-center justify-center flex-col gap-4">
                    ...
                    <button type="button" className="px-4 py-2 rounded-lg bg-[#0095F6] text-white">Select from computer</button>
